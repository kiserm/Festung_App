...
export default class Station11Screen extends React.Component {
      // set a title for the navigation bar at the top and the design is in the file ../navigation/StackNavigator.js
      static navigationOptions = {
        title: "Station11Screen",    
      };
        ...
        return (      
          <View style={styles.anyWholeScreen}>
            ...
            <View style={styles.HowToButtonContainer}>
              ...
              <TouchableHighlight onPress={() => this.props.navigation.navigate('Station12')} underlayColor="rgba(96,100,109, 1)" style={styles.anyButtonStyle}>
