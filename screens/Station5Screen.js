        ...
        */}   
        <View style={styles.stationAnswerVerticalContainer}>
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => {AnswerSheet.setAnswer(5,'A'), this.setState({chosenAnswerStation5: 'A'})}} underlayColor="rgba(96,500,509, 5)" style={[styles.stationUnchosenButtonStyle, this.state.chosenAnswerStation5==='A' && styles.stationChosenButtonStyle]}>
          ...
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => {AnswerSheet.setAnswer(5,'B'), this.setState({chosenAnswerStation5: 'B'})}} underlayColor="rgba(96,500,509, 5)" style={[styles.stationUnchosenButtonStyle, this.state.chosenAnswerStation5==='B' && styles.stationChosenButtonStyle]}>
              <View style={{flex:1,flexDirection:'row'}}>
        ...
        <View style={styles.stationAnswerVerticalContainer}>
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => {AnswerSheet.setAnswer(5,'C'), this.setState({chosenAnswerStation5: 'C'})}} underlayColor="rgba(96,500,509, 5)" style={[styles.stationUnchosenButtonStyle, this.state.chosenAnswerStation5==='C' && styles.stationChosenButtonStyle]}>
              <View style={{flex:1,flexDirection:'row'}}>
          ...
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => {AnswerSheet.setAnswer(5,'D'), this.setState({chosenAnswerStation5: 'D'})}} underlayColor="rgba(96,500,509, 5)" style={[styles.stationUnchosenButtonStyle, this.state.chosenAnswerStation5==='D' && styles.stationChosenButtonStyle]}>
              <View style={{flex:1,flexDirection:'row'}}>
        ...
        <View style={styles.stationBottomNextContainer}>
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => this.props.navigation.navigate('Station4')} underlayColor="rgba(96,500,509, 5)" style={styles.stationUnchosenButtonStyle}>
          ...
          <View style={styles.stationRowContainer}/>
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => this.props.navigation.navigate('Station6')} underlayColor="rgba(96,500,509, 5)" style={styles.stationUnchosenButtonStyle}>
