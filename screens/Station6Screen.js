      ...
      return (      
        <View style={styles.anyWholeScreen}>
          ...
          <View style={styles.stationInfoTitleTextContainer}>
            <Text style={styles.stationInfoTitleTextFormat}>Station 6 - Info </Text>
          </View>
          ...
          <Image source={require('../assets/images/badgerQuestion1.png')} style={styles.station6InfoImageStyle}/>
    ...
    return(
      <View style={styles.stationInfoBottomContainer}>
        ...
        <View style={styles.stationInfoAudioContainer}>
            <TouchableHighlight onPress={() => {AudioFile.audioFunction('Station6Info','play',false)}} underlayColor="rgba(96,100,109, 1)" style={styles.stationInfoButtonAudioStyle}>
              <IconMaterialCommunityIcons name='play-circle-outline' size={hp('7%')} color='#C92732'/>
            </TouchableHighlight>
            <TouchableHighlight onPress={() => {AudioFile.audioFunction('Station6Info','pause',true)}} underlayColor="rgba(96,100,109, 1)" style={styles.stationInfoButtonAudioStyle}>
              <IconMaterialCommunityIcons name='pause-circle-outline' size={hp('7%')} color='#C92732'/>
            </TouchableHighlight>
            <TouchableHighlight onPress={() => {AudioFile.audioFunction('Station6Info','stop',false)}} underlayColor="rgba(96,100,109, 1)" style={styles.stationInfoButtonAudioStyle}>
        ...
        */}     
        ...
        <TouchableHighlight onPress={() => {
                if(AudioFile.getAudioStatus('Station6Info')){
                  AudioFile.audioFunction('Station6Info','pause');
