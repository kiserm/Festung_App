...
/**
 * IDEA:
 * this screen shows the second task of the quiz
 */
        ...
        */}   
        <View style={styles.stationAnswerVerticalContainer}>
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => {AnswerSheet.setAnswer(2,'A'), this.setState({chosenAnswerStation2: 'A'})}} underlayColor="rgba(96,200,209, 2)" style={[styles.stationUnchosenButtonStyle, this.state.chosenAnswerStation2==='A' && styles.stationChosenButtonStyle]}>
          ...
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => {AnswerSheet.setAnswer(2,'B'), this.setState({chosenAnswerStation2: 'B'})}} underlayColor="rgba(96,200,209, 2)" style={[styles.stationUnchosenButtonStyle, this.state.chosenAnswerStation2==='B' && styles.stationChosenButtonStyle]}>
              <View style={{flex:1,flexDirection:'row'}}>
        ...
        <View style={styles.stationAnswerVerticalContainer}>
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => {AnswerSheet.setAnswer(2,'C'), this.setState({chosenAnswerStation2: 'C'})}} underlayColor="rgba(96,200,209, 2)" style={[styles.stationUnchosenButtonStyle, this.state.chosenAnswerStation2==='C' && styles.stationChosenButtonStyle]}>
              <View style={{flex:1,flexDirection:'row'}}>
          ...
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => {AnswerSheet.setAnswer(2,'D'), this.setState({chosenAnswerStation2: 'D'})}} underlayColor="rgba(96,200,209, 2)" style={[styles.stationUnchosenButtonStyle, this.state.chosenAnswerStation2==='D' && styles.stationChosenButtonStyle]}>
              <View style={{flex:1,flexDirection:'row'}}>
        ...
        <View style={styles.stationBottomNextContainer}>
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => this.props.navigation.navigate('Station1')} underlayColor="rgba(96,200,209, 2)" style={styles.stationUnchosenButtonStyle}>
          ...
          <View style={styles.stationRowContainer}/>
          <View style={styles.stationRowContainer}>
            <TouchableHighlight onPress={() => this.props.navigation.navigate('Station3')} underlayColor="rgba(96,200,209, 2)" style={styles.stationUnchosenButtonStyle}>
